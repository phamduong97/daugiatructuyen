...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><i class="fas fa-file-alt"></i> Danh sách tài liệu</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <tbody>
                  <tr>
                      ...
                      <td style="text-align: center;">
                       ...
                       <td style="text-align: center;">
                          <a href="">
                            <i class="far fa-file-word"></i> Văn bản pháp luật
                          </a>
                      </td>
      ...
      <div class="modal-dialog">
        ...
        <form class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title"><b><i class="fas fa-file-alt"></i> Thêm mới tài liệu</b></h4>
          </div>
          <div class="modal-body">
            <div class="form-group">
              <label for="email">Tên tài liệu:</label>
              <input type="email" class="form-control" placeholder="Nhập tên tài liệu...">
            </div>
             <div class="form-group">
              <label for="email">File đính kèm:</label>
              <input type="file" class="form-control" placeholder="Nhập tên tài liệu...">
            </div>
